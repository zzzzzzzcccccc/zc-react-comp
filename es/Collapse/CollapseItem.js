...
var CollapseItem = function CollapseItem(_ref) {
  ...
  var handleClickTitle = function handleClickTitle(e) {
    ...
    if (multiple) {
      updateActualValue(isActive ? _toConsumableArray(actualValue).filter(function (v) {
        return v !== value;
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: classNames(cssPrefix, isActive && "".concat(cssPrefix, "-active"), disabled && "".concat(cssPrefix, "-disabled"), className),
    style: style

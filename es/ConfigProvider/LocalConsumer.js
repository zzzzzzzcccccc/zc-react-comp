...
var LocalConsumer = function LocalConsumer(_ref) {
  var _ref$componentName = _ref.componentName,
      componentName = _ref$componentName === void 0 ? 'global' : _ref$componentName,
      children = _ref.children;
  var context = useContext(ConfigContext);

  var _useState = useState(context && context.local ? context.local : defaultLocal),
      _useState2 = _slicedToArray(_useState, 2),
      local = _useState2[0],
      setLocal = _useState2[1];

  var localComp = local[componentName];
  useEffect(function () {
